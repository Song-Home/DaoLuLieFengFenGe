...
class VGG16UNet(nn.Module):
    def __init__(self, num_classes, pretrain_backbone: bool = False):
        ...
        self.up1 = Up(c, self.stage_out_channels[2])
        c = self.stage_out_channels[2] + self.stage_out_channels[2]
        self.up2 = Up(c, self.stage_out_channels[1])
        c = self.stage_out_channels[1] + self.stage_out_channels[1]
        self.up3 = Up(c, self.stage_out_channels[0])
        c = self.stage_out_channels[0] + self.stage_out_channels[0]
